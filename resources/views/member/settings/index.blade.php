    ...
    <div class="invisible lg:visible flex w-0 md:w-0 lg:w-full bg-gradient-to-tr from-green-600 to-cyan-500 i justify-around items-center">
      <div>
        ...
        <form action="/logout" onsubmit="return confirm('Are you sure?')" method="POST">
          <a href="/" class="bg-white text-green-600 mt-2 py-2 px-4 rounded-lg font-bold border border-white mb-2 me-2 hover:bg-transparent hover:text-white">
            Beranda
          </a>
          @csrf
      ...
      <div class="max-w-md w-full space-y-8">
        <div class="text-center">
          <h2 class="mt-6 text-3xl font-bold text-gray-900">
            {{ Auth::user()->name }} | {{ Auth::user()->membership->package }}
          </h2>
        ...
        <form class="mt-8 space-y-6" action="/m1/settings" method="POST">
          @csrf
          @method('PUT')
          ...
          <div class="mt-8 content-center">
            ...
            <input
              class="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-indigo-500 @error('password_confirmation') border border-red-500 rounded outline-none @enderror"
